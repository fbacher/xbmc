...
void CPeripheralCecAdapter::SetConfigurationFromSettings(void)
{
  ...
  strWakeDevices = UnicodeUtils::Trim(strWakeDevices);
  ...
  strStandbyDevices = UnicodeUtils::Trim(strStandbyDevices);
                                                 ...
                                                 cec_logical_addresses& addresses)
{
  for (size_t iPtr = 0; iPtr < strString.size(); iPtr++)
  {
    ...
    strDevice = UnicodeUtils::Trim(strDevice);
    if (!strDevice.empty())
    {
      int iDevice(0);
                                                  ...
                                                  const std::string& strAdvancedSettingName)
{
  ...
  if (!GetSettingString(strAdvancedSettingName).empty())
  {
    ...
    strPowerOffDevices = UnicodeUtils::Trim(strPowerOffDevices);
